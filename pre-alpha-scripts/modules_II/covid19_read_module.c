...
printf(" %s %s %s %d %s %d %d %d %f %d\n", temporary->name, temporary->country_code, temporary->continent, temporary->population,indicator, temporary2->Infected_Weekly_count, temporary2->year, temporary2->week, temporary2->Infected_rate_14_day, temporary2->Infected_cumulative_count);
}else if (strcmp(indicator,"deaths")){
printf(" %s %s %s %d %s %d %d %d %f %d\n", temporary->name, temporary->country_code, temporary->continent, temporary->population,indicator, temporary2->Death_Weekly_count, temporary2->year, temporary2->week, temporary2->Death_rate_14_day, temporary2-> Death_cumulative_count);
