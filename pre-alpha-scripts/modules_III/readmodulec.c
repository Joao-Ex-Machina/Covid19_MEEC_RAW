...
void printlist (country_list *head, week_list *auxweek)
{
    ...
    printf(" %s,%s,%s,%ld,deaths,%ld,%ld,%ld,%lf,%ld\n", temporary->country, temporary->country_code, temporary->continent, temporary->population,tempora
}
...
void le_valor (char *linha,char *name,char *country_code,char *continent,long *population,char *indicator,long *weekly_count,long *year,long *week,float *rate_14_day,long *cumulative_count)
{
